...
class SOLENT_CAMPERS:
    def __init__(self):
        ...
        self.Message6.configure(text='''Solent Campers''')
        ...
        self.Button2.configure(text='''1.Advisor Login''')
        ...
        self.Button4.configure(text='''2.Customer Login''')
        ...
        self.Button6.configure(text='''3.Admin Login''')
...
class SOLENT_CAMPERS_checkin:
    ...
    def __init__(self):
        ...
        _ana1color = '#ffffff' # X11 color: 'white'
        _ana2color = '#ffffff' # X11 color: 'white'
        font10 = "-family {Courier New} -size 10 -weight normal -slant"              " roman -underline 0 -overstrike 0"
        font11 = "-family {Segoe UI} -size 30 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font12 = "-family {Segoe UI} -size 18 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font13 = "-family {Segoe UI} -size 17 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font14 = "-family {Segoe UI} -size 16 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font15 = "-family {Segoe UI} -size 19 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font16 = "-family {Segoe UI} -size 15 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font9 = "-family {Segoe UI} -size 9 -weight normal -slant "              "roman -underline 0 -overstrike 0"
        ...
        self.Message3.configure(text='''Advisor Login''')
        ...
        self.Label4.configure(text='''ENTER NUMBER''')
        ...
        self.Label6.configure(text='''CHOOSE YOUR VAN''')
...
while True:
    ...
    if k == "1":
        ...
        while True:
            ...
            v = int(a)
        v = int(a)
        f = open("solent.dat", "rb")
        f1 = open("solent.dat", "ab")
        n = 0
        try:
            while True:
                s = pickle.load(f)
        ...
        f.close()
        f1.close()
        os.remove("solent.dat")
        os.rename("solent.dat", "solent.dat")
...
class New_Toplevel:
    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                ...
                try:
                    ...
                    if n == 0:
                        self.Text1.insert(INSERT, "THANK YOU""\n")
        ...
        _ana2color = '#ffffff' # X11 color: 'white'
        font10 = "-family {Courier New} -size 10 -weight normal -slant"              " roman -underline 0 -overstrike 0"
        font11 = "-family {Segoe UI} -size 23 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font12 = "-family {Segoe UI} -size 24 -weight bold -slant "              "roman -underline 0 -overstrike 0"
        font9 = "-family {Segoe UI} -size 9 -weight normal -slant "              "roman -underline 0 -overstrike 0"
        ...
        self.Label1.configure(text='''ENTER THE CUSTOMER NO.   :''')
